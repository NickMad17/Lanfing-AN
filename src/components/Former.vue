...
<div class="scr w-full h-screen flex justify-center absolute pt-4 top-0 bg-second z-20" v-if="!complete">
  <div class="w-72 flex flex-col items-center">
    <h1 class="text-center text-[16px]">Для того что бы попасть дальше тебе надо составить слово, которое было "зашифровано" в <span class="text-blue-500">7-ми</span> открытках.</h1>
